...
public class Pond extends Activity {
 ...
 // location
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pond, menu);
		return true;
	}
	@Override
	...
	private void openSettings() {
		Intent intent = new Intent(Pond.this, Lang.class);
	    startActivity(intent);
		
	}

	private void save() {
		Intent intent = new Intent(Pond.this, Lib.class);
	    startActivity(intent);
	}
	private void toTree() {
		Intent intent = new Intent(Pond.this, Tree.class);
		startActivity(intent);
	}	
	private void toHack() {
		Intent intent = new Intent(Pond.this, Hack.class);
		startActivity(intent);
	}
