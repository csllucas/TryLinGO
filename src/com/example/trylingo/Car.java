...
public class Car extends Activity {
	...
	private void openSettings() {
		Intent intent = new Intent(Car.this, Lang.class);
	    startActivity(intent);
		
	}

	private void save() {
		Intent intent = new Intent(Car.this, Lib.class);
	    startActivity(intent);
	}
	private void toTree() {
		Intent intent = new Intent(Car.this, Tree.class);
		startActivity(intent);
	}	
	private void toSsign() {
		Intent intent = new Intent(Car.this, Ssign.class);
		startActivity(intent);
	}
