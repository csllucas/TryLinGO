...
public class Ssign extends Activity {
    float x1,x2;
    float y1, y2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ssign);
        gps = new GPSTracker(Ssign.this);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ssign, menu);
		return true;
	}
	@Override
	...
	private void openSettings() {
		Intent intent = new Intent(Ssign.this, Lang.class);
	    startActivity(intent);
		
	}

	private void save() {
		Intent intent = new Intent(Ssign.this, Lib.class);
	    startActivity(intent);
	}
	private void toCar() {
		Intent intent = new Intent(Ssign.this, Car.class);
		startActivity(intent);
	}	
	private void toStore() {
		Intent intent = new Intent(Ssign.this, Store.class);
		startActivity(intent);
	}
