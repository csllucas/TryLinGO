...
public class Hack extends Activity {
	...
	private void openSettings() {
		Intent intent = new Intent(Hack.this, Lang.class);
		startActivity(intent);

	}

	private void save() {
		Intent intent = new Intent(Hack.this, Lib.class);
		startActivity(intent);

	}
	private void toCoffee() {
		Intent intent = new Intent(Hack.this, MainActivity.class);
		startActivity(intent);
	}
	private void toPond() {
		Intent intent = new Intent(Hack.this, Pond.class);
		startActivity(intent);
	}	
